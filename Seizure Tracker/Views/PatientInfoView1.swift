...
/*
 ...
 @State private var heightValue: String = ""      // value in current heightUnit
 @State private var weightValue: String = ""      // value in current weightUnit
 ...
 TextField("e.g. Anna", text: $firstName)
 ...
 TextField("e.g. Novak", text: $lastName)
 .textFieldStyle(.plain)
 
 Divider()
 }
 
 // Age / Height / Weight row (stacked)
